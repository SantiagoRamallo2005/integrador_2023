                        ...
                        <div id="mainNav" class="collapse navbar-collapse tm-bg-white">
                            <div class="navbar-nav ml-auto d-flex">
                                ...
                                <div class="ms-auto nav-item">
                                    <a class="nav-link" href="#" data-toggle="modal" data-target="#exampleModal">Login / Registro</a>
                                </div>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="newUsername" placeholder="Ingresa tu nuevo usuario">
                                    </div>
                                    <div class="form-group">
